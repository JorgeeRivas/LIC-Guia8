...
function inputDigitsOnly(e){
    ...
    document.getElementById('msgerror').style.width = "100%";
   ...
   keyCode!=27 && keyCode!=32){
    ...
    document.getElementById('txt').style.height = "32px";
    document.getElementById('txt').style.paddingTop = "4px";
    document.getElementById('txt').style.paddingLeft = "9px";
    document.getElementById('txt').style.width = "100%";
    document.getElementById('txt').innerHTML = "Sólo se aceptan caracteres alfabéticos";
    if(evt.preventDefault) evt.preventDefault();
    evt.returnValue = false;
    return false;
    }
...
function init() {
addEventHandler(self.document.contact.comentarios, 'keypress',inputAlphanumeric);
addEventHandler(self.document.contact.nombre, 'keypress',inputAlphanumericOnly);
